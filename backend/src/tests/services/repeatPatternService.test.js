const repeatPatternService = require('../../services/repeatPatternService');
...
describe('RepeatPatternService', () => {
  ...
  describe('checkTaskOverlaps', () => {
    ...
    test('should handle tasks on consecutive days without overlap', () => {
      const newTask = {
        selectedDay: '2023-07-20',
        startTime: '2023-07-20T22:00:00.000Z',  // 10 PM on July 20
        endTime: '2023-07-20T23:59:59.000Z'     // 11:59 PM on July 20 (same day)
      };
      
      const existingTasks = [{
        id: 1,
        selectedDay: '2023-07-21',
        startTime: '2023-07-21T00:00:00.000Z',  // 12 AM on July 21
        endTime: '2023-07-21T03:00:00.000Z'     // 3 AM on July 21
      }];
      
      // These tasks are on consecutive days but don't overlap since tasks cannot span midnight
      expect(repeatPatternService.checkTaskOverlaps(newTask, existingTasks)).toBe(false);
    });
  });
});